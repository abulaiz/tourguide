		...
		<div class="container">				
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav"><a href="/">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="#"> Gift Shop</a></p>
				</div>	
			</div>
		</div>
	</section>
	...
	<section class="post-content-area">
		<div class="container">
			<div class="row d-flex justify-content-center">
			    <div class="menu-content pt-50 pb-50 col-lg-8">
			        <div class="title text-center">
			            <h1 class="mb-10">Gift Shops in Bandung</h1>
			            <p>Here are our best gift shop around the city.</p>
			        </div>
			    </div>
			</div>
			<div class="row">
